...
full_rnn_cell_2 = layers.SimpleRNN(units, # How many output units (per iteration of RNN)    # Formerly: SimpleRNN
                                   input_shape=(1, dimensions), # 1 row of 512 pixels
                                   kernel_regularizer=regularizers.l2(0.001),
                                   recurrent_regularizer=regularizers.l2(0.0001),
                                   bias_regularizer=regularizers.l2(0.001), 
...
model.add(layers.Dense(256, activation='relu', kernel_regularizer=regularizers.l2(0.03)))
