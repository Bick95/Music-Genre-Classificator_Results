...
full_rnn_cell_1 = layers.SimpleRNN(units, # How many output units (per iteration of RNN)    # Formerly: SimpleRNN
...
full_rnn_cell_3 = layers.SimpleRNN(units, 
                                   input_shape=(1, dimensions),
                                   kernel_regularizer=regularizers.l2(0.001),
                                   recurrent_regularizer=regularizers.l2(0.01),
                                   bias_regularizer=regularizers.l2(0.001),
...
full_rnn_cell_4 = layers.SimpleRNN(units, 
                                   input_shape=(1, dimensions),
                                   kernel_regularizer=regularizers.l2(0.001),
                                   recurrent_regularizer=regularizers.l2(0.01),
                                   bias_regularizer=regularizers.l2(0.001),
...
full_rnn_cell_5 = layers.SimpleRNN(units, 
                                   input_shape=(1, dimensions),
                                   kernel_regularizer=regularizers.l2(0.001),
                                   recurrent_regularizer=regularizers.l2(0.01),
                                   bias_regularizer=regularizers.l2(0.001),
...
full_rnn_cell_6 = layers.SimpleRNN(units, 
                                   input_shape=(1, dimensions),
                                   kernel_regularizer=regularizers.l2(0.001),
                                   recurrent_regularizer=regularizers.l2(0.01),
                                   bias_regularizer=regularizers.l2(0.001),
...
model.add(full_rnn_cell_4)
model.add(full_rnn_cell_5)
model.add(full_rnn_cell_6)
