...
full_rnn_cell_1 = layers.LSTM(units, # How many output units (per iteration of RNN)    # Formerly: SimpleRNN
...
full_rnn_cell_2 = layers.LSTM(units, # How many output units (per iteration of RNN)    # Formerly: SimpleRNN
                                   input_shape=(1, dimensions), # 1 row of 512 pixels
                                   kernel_regularizer=regularizers.l2(0.0001),
                                   recurrent_regularizer=regularizers.l2(0.0001),
                                   bias_regularizer=regularizers.l2(0.0001), 
...
full_rnn_cell_3 = layers.LSTM(units, 
